...
| Legal Counsel | MSSP/Technical Team |
|--------------|---------------------|
| Notification strategy | Threat containment & eradication |
| Regulator liaison | Forensic analysis & root cause |
| Drafting notices & Q&As | Log collection & evidence preservation |
| Attorney-client privilege protection | Technical remediation & patching |
| Contractual liability analysis | Vendor coordination (EDR, SIEM, etc.) |
